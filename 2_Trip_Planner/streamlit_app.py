...
if __name__ == "__main__":
    ...
    with st.sidebar:
        ...
        <a href="https://github.com/crewAIInc/crewAI/" target="_blank">
            <img src="https://github.com/crewAIInc/crewAI/blob/main/docs/images/crewai_logo.png?raw=true" alt="CrewAI Logo" style="width:100px;"/>
        </a>
        """,
            unsafe_allow_html=True
        )
...
if submitted:
    with st.status("🤖 **Agents at work...**", state="running", expanded=True) as status:
        with st.container(height=500, border=False) as container:
            sys.stdout = StreamToExpander(container)
...
# Here is an example of simpler way to capture real-time console output in Streamlit:
# import sys
...
#         # Show all captured output at once
